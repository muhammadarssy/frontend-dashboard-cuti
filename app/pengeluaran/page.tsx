...
import { usePengeluarans } from '@/hooks/usePengeluaran';
...
export default function PengeluaranPage() {
  ...
  const { data, isLoading } = usePengeluarans(
    undefined,
    kategori || undefined,
    keperluan || undefined,
    penerima || undefined,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Kelola transaksi pengeluaran barang (stok keluar)</p>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg border space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div>
            <label className="text-sm font-medium mb-2 block">Keperluan</label>
            <Input
          ...
          <div>
            <label className="text-sm font-medium mb-2 block">Penerima</label>
            <Input
      ...
      <div className="bg-white p-6 rounded-lg border">
        <PengeluaranTable data={data?.data || []} isLoading={isLoading} />
